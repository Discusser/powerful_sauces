...
public class PowerfulSaucesItems {
    ...
    public static final RegistrySupplier<Item> KETCHUP = registerSauce("ketchup", 0x850101);

    public static RegistrySupplier<Item> registerSauce(String name, int textColor) {
